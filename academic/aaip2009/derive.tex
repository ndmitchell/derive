...
-- transform a value to the |Output| type using
-- SYB \cite{lammel:syb}
...
The most obvious thing to do with a value of our DSL is to apply it and generate an output, in HSE syntax. There is a package (\todo{called what}) that automatically translates HSE syntax into Template Haskell, so we can continue and use that to integrate with Template Haskell and GHC. We can wrap our tool in a command line and perform these steps online.
