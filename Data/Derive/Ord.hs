...
dslOrd =
    ...
    "Ident" (List [String "Ord"])]),List [App "TyApp" (List [App
    "TyCon" (List [App "UnQual" (List [App "Ident" (List [String
    "DataName"])])]),App "TyVar" (List [App "Ident" (List [String "a"]
    )])])],List [App "InsDecl" (List [App "FunBind" (List [List [App
    "Match" (List [App "Ident" (List [String "compare"]),List [App
    "PVar" (List [App "Ident" (List [String "a"])]),App "PVar" (List [
    App "Ident" (List [String "b"])])],App "Nothing" (List []),App
    "UnGuardedRhs" (List [Application (List [App "Var" (List [App
    "UnQual" (List [App "Ident" (List [String "check"])])]),App "Var"
    (List [App "UnQual" (List [App "Ident" (List [String "a"])])]),App
    ...
    "Symbol" (List [String "&"])])]),Head])) (Concat (List [List [App
    "Con" (List [App "UnQual" (List [App "Ident" (List [String "EQ"])]
    )])],Reverse (MapField (Application (List [App "Var" (List [App
    "UnQual" (List [App "Ident" (List [String "compare"])])]),App
    ...
    )),List [App "Match" (List [App "Ident" (List [String "check"]),
    List [App "PVar" (List [App "Ident" (List [String "x"])]),App
    "PVar" (List [App "Ident" (List [String "y"])])],App "Nothing" (
    List []),App "UnGuardedRhs" (List [Application (List [App "Var" (
    List [App "UnQual" (List [App "Ident" (List [String "compare"])])]
    ),App "Paren" (List [App "App" (List [App "Var" (List [App
    "UnQual" (List [App "Ident" (List [String "tag"])])]),App "Var" (
    List [App "UnQual" (List [App "Ident" (List [String "x"])])])])]),
    App "Paren" (List [App "App" (List [App "Var" (List [App "UnQual"
    (List [App "Ident" (List [String "tag"])])]),App "Var" (List [App
    "UnQual" (List [App "Ident" (List [String "y"])])])])])])]),App
    "BDecls" (List [List []])])]])]),App "FunBind" (List [List [App
    "Match" (List [App "Symbol" (List [String "&"]),List [App "PApp" (
    List [App "UnQual" (List [App "Ident" (List [String "EQ"])]),List
    ...
    "&"]),List [App "PVar" (List [App "Ident" (List [String "x"])]),
    App "PWildCard" (List [])],App "Nothing" (List []),App
    ...
    List [String "tag"]),List [App "PParen" (List [App "PRec" (List [
