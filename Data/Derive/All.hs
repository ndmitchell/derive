...
derivations = [makeArbitrary,makeArbitraryOld,makeArities,makeBinary,makeBinaryDefer,makeBounded,makeData,makeDefault,makeEnum,makeEnumCyclic,makeEq,makeFold,makeFrom,makeHas,makeIs,makeMonoid,makeNFData,makeOrd,makePlateTypeable,makeRef,makeSerial,makeSet,makeTypeable]
-- GENERATED STOP
